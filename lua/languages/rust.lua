...
nnoremap("<leader>cv",":lua require('crates').show_versions_popup()<cr>",'silent',{ft='rust'})
nnoremap("<leader>cf",":lua require('crates').show_features_popup()<cr>",'silent',{ft='rust'})
